...
export const zhDict: Record<string, I18nValue> = {
  ...
  'settings.cutout': '自动去背',
  'settings.cutoutTolerance': '去背强度',
  'settings.cutoutHint':
    '开启后按颜色容差去掉图片的纯色 / 简单背景，保存为透明 PNG；图片不会上传。强度越高去掉的背景越多。对背景干净的图片效果最好。',
  ...
  'settings.autoMoveHint': '开启后宠物会自己在桌面上走动 / 奔跑 / 跳跃，并保持清醒不再自动入睡；关闭则按上面的「睡眠等待」入睡。任何点击或拖拽都会打断自主活动。',
  'settings.behaviorSection': '行为',
  'settings.petScale': '宠物大小',
  'settings.sleepTimeout': '睡眠等待',
  'settings.wanderSpeed': '走动速度',
  'settings.activityFrequency': '活跃频率',
  'settings.snapToEdge': '贴边吸附',
  'settings.stayOnOneDisplay': '只在单屏活动',
  'settings.behaviorHint':
    '「贴边吸附」会在拖拽松手时把宠物贴齐最近的屏幕边缘；关闭「只在单屏活动」后，宠物走动时可以跨到另一块显示器。',
  'settings.updateUnsupported': '自动更新尚未接入，请手动下载新版本',
  ...
  'settings.updateAutoCheck': '启动时检查更新',
  'settings.updateAutoDownload': '自动下载新版本',
  'settings.updateChannel': '更新渠道',
  'settings.updateChannelStable': '稳定版',
  'settings.updateChannelPrerelease': '预览版',
  'settings.updateVersion': '当前版本',
  'settings.updateStatus': '状态',
  'settings.updateProgress': '下载进度',
  'settings.updateNotes': '更新日志',
  'settings.checkUpdate': '🔍 立即检查更新',
  'settings.downloadUpdate': '⬇️ 下载更新',
  'settings.restartUpdate': '🔄 立即重启更新',
  'settings.openRelease': '↗️ 打开下载页',
  'settings.updateIdle': '尚未检查',
  'settings.updateChecking': '正在检查…',
  'settings.updateAvailable': '发现新版本 v{v}',
  'settings.updateDownloading': '正在下载… {p}%',
  'settings.updateDownloaded': 'v{v} 已就绪',
  'settings.updateUpToDate': '已是最新版本（v{v}）',
  'settings.updateDev': '开发模式无法在线更新',
  'settings.updateError': '检查失败，将按计划自动重试',
  'greet.lines': [
    '好久不见呀，想我了吗～',
    '主人，起来伸个懒腰吧！',
    '窗外天气不错，适合出门走走哦 ☀️',
  ...
  'settings.providerNew': '＋ 新建',
  'settings.providerDelete': '🗑️ 删除',
  'settings.providerName': '名称',
  'settings.providerUntitled': '未命名供应商',
  'settings.chatMaxTokens': '回复长度上限',
  'settings.chatTemperature': '发散程度',
  'settings.chatVerbosity': '话多话少',
  'settings.verbosityBrief': '简短',
  'settings.verbosityNormal': '正常',
  'settings.verbosityChatty': '话痨',
  'settings.chatEmoji': '允许 emoji',
  'settings.chatUsage': '今日用量',
  'settings.chatUsageValue': '{n} 条消息 · 约 {t} tokens',
  'settings.chatUsageEmpty': '今天还没聊过',
  'settings.aiHint':
    '支持任何 OpenAI 兼容接口：OpenAI、DeepSeek、Moonshot、Ollama 等。可保存多套供应商配置并一键切换。<br/>API Key 保存在本机的 config.json 中——Tauri 版目前是明文存储，尚未接入系统密钥库加密，请留意这一点。',
  ...
  'update.availableManual': '✨ 发现新版本 v{v}，点击「打开下载页」手动更新～',
  'update.checking': '🔍 正在检查新版本…',
  'update.downloadStart': '⬇️ 开始下载 v{v}…',
  'update.downloadProgress': '⬇️ 正在下载 v{v}：{p}%',
  'update.downloadedNotice': '✅ v{v} 已下载完成',
  'update.installed': '🎉 我刚刚更新到了 v{v}！',
  'update.deferred': '📦 v{v} 已准备好，下次退出应用时会自动完成更新～',
  'update.retryNotice': '更新检查失败（{err}）。我会在 {delay} 后自动重试，也可以随时去设置里手动检查。',
  'update.delayMin': '{n} 分钟',
  ...
  // One-click update badge (pet window + settings header)
  'updateBadge.label': '软件更新',
  'updateBadge.available': '✨ 发现新版本 v{v}，点我立即更新',
  'updateBadge.downloading': '⬇️ 正在下载 {p}%，点我下完自动安装',
  'updateBadge.downloaded': '🚀 v{v} 已就绪，点我重启并更新',
...
export const enDict: Record<string, I18nValue> = {
  ...
  'settings.cutout': 'Background removal',
  'settings.cutoutTolerance': 'Removal strength',
  'settings.cutoutHint':
    'Removes a solid / simple background by colour tolerance and saves the result as a transparent PNG; the image is never uploaded. Higher strength removes more background. Works best on clean backgrounds.',
  ...
  'settings.autoMoveHint': 'When on, the pet walks / runs / jumps around your desktop on its own and stays awake (no auto-sleep); when off it falls asleep after the "Sleep after" delay above. Any click or drag interrupts the wandering.',
  'settings.behaviorSection': 'Behavior',
  'settings.petScale': 'Pet size',
  'settings.sleepTimeout': 'Sleep after',
  'settings.wanderSpeed': 'Walk speed',
  'settings.activityFrequency': 'Activity rate',
  'settings.snapToEdge': 'Snap to edges',
  'settings.stayOnOneDisplay': 'Stay on one display',
  'settings.behaviorHint':
    '"Snap to edges" pulls the pet flush to the nearest screen edge when you drop it. Turn off "Stay on one display" to let it wander across to another monitor.',
  'settings.updateUnsupported': 'Auto-update is not available yet — download new versions manually',
  ...
  'settings.updateSection': '🔄 Update',
  'settings.updateAutoCheck': 'Check on startup',
  'settings.updateAutoDownload': 'Auto-download updates',
  'settings.updateChannel': 'Channel',
  'settings.updateChannelStable': 'Stable',
  'settings.updateChannelPrerelease': 'Pre-release',
  'settings.updateVersion': 'Current version',
  'settings.updateStatus': 'Status',
  'settings.updateProgress': 'Download progress',
  'settings.updateNotes': 'Release notes',
  'settings.checkUpdate': '🔍 Check for Updates',
  'settings.downloadUpdate': '⬇️ Download Update',
  'settings.restartUpdate': '🔄 Restart & Update',
  'settings.openRelease': '↗️ Open Release Page',
  'settings.updateIdle': 'Not checked yet',
  'settings.updateChecking': 'Checking…',
  'settings.updateAvailable': 'New version v{v} found',
  'settings.updateDownloading': 'Downloading… {p}%',
  'settings.updateDownloaded': 'v{v} ready',
  'settings.updateUpToDate': 'You are up to date (v{v})',
  'settings.updateDev': 'Online updates are unavailable in dev mode',
  'settings.updateError': 'Check failed — auto retry is scheduled',
  'greet.lines': [
  ...
  'settings.providerNew': '＋ New',
  'settings.providerDelete': '🗑️ Delete',
  'settings.providerName': 'Name',
  'settings.providerUntitled': 'Untitled provider',
  'settings.chatMaxTokens': 'Reply length cap',
  'settings.chatTemperature': 'Creativity',
  'settings.chatVerbosity': 'Talkativeness',
  'settings.verbosityBrief': 'Brief',
  'settings.verbosityNormal': 'Normal',
  'settings.verbosityChatty': 'Chatty',
  'settings.chatEmoji': 'Allow emoji',
  'settings.chatUsage': "Today's usage",
  'settings.chatUsageValue': '{n} messages · ~{t} tokens',
  'settings.chatUsageEmpty': 'No chat today',
  'settings.aiHint':
    'Works with any OpenAI-compatible API: OpenAI, DeepSeek, Moonshot, Ollama, etc. You can save several provider profiles and switch with one click.<br/>The API key is stored in the local config.json — the Tauri build keeps it in plain text for now (OS keychain encryption is not wired up yet), so keep that in mind.',
  ...
  'update.availableManual': '✨ A new version (v{v}) is available — open the release page to update~',
  'update.checking': '🔍 Checking for updates…',
  'update.downloadStart': '⬇️ Downloading v{v}…',
  'update.downloadProgress': '⬇️ Downloading v{v}: {p}%',
  'update.downloadedNotice': '✅ v{v} downloaded',
  'update.installed': '🎉 I just updated to v{v}!',
  'update.deferred': '📦 v{v} is ready — it will finish installing when you quit the app~',
  'update.retryNotice': 'Update check failed ({err}). I will retry automatically in {delay}. You can also check manually in Settings.',
  'update.delayMin': '{n} min',
  ...
  // One-click update badge (pet window + settings header)
  'updateBadge.label': 'Software update',
  'updateBadge.available': '✨ New version v{v} — click to update',
  'updateBadge.downloading': '⬇️ Downloading {p}% — click to auto-install when done',
  'updateBadge.downloaded': '🚀 v{v} ready — click to restart & update',
